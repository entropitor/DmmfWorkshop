...
module ShoppingCartApi =
    ...
    type EmptyCartData = Empty of ()  //what data to store?
    type ActiveCartData = Active of CartContents  //what data to store?
    type PaidCartData = Paid of CartContents //what data to store?
